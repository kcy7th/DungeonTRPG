...
namespace DungeonTRPG
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            ActiveItem item6 = new ActiveItem("기술머신", "아이템을 사용하면 스킬을 배울 수 있다.", 5000, new List<Job>() { Job.Warrior }, new List<IEffect>() { new LearnSkill(new Skill("몸통 박치기", "적에게 10의 피해를 입힌다.", new List<IEffect>() { new HpDown(20) })) }, UseableIn.OnlyIdle, true);
