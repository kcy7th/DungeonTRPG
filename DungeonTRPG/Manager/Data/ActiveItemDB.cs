...
namespace DungeonTRPG.Manager.Data
{
    internal class ActiveItemDB
    {
        ...
        {
            { 1000, new ActiveItem("체력 물약", "사용시 체력을 10 회복한다.", 100, new List<Job>{ Job.None }, new List<IEffect>(){ new HpRecovery(10) }, UseableIn.Both, true) },
            { 1001, new ActiveItem("체력 물약", "사용시 체력을 50 회복한다.", 200, new List<Job>{ Job.None }, new List<IEffect>(){ new HpRecovery(50) }, UseableIn.Both, true) },
            { 1002, new ActiveItem("체력 물약", "사용시 체력을 100 회복한다.", 400, new List<Job>{ Job.None }, new List<IEffect>(){ new HpRecovery(100) }, UseableIn.Both, true) },
            { 1003, new ActiveItem("체력 물약", "사용시 체력을 200 회복한다.", 800, new List<Job>{ Job.None }, new List<IEffect>(){ new HpRecovery(200) }, UseableIn.Both, true) },
            { 1004, new ActiveItem("체력 물약", "사용시 체력을 전부 회복한다.", 3000, new List<Job>{ Job.None }, new List<IEffect>(){ new HpRecovery(9999999) }, UseableIn.OnlyCombat, true) },
            { 1005, new ActiveItem("마나 물약", "사용시 마나를 10 회복한다.", 100, new List<Job>{ Job.None }, new List<IEffect>(){ new MpRecovery(10) }, UseableIn.Both, true) },
            { 1006, new ActiveItem("마나 물약", "사용시 마나를 50 회복한다.", 200, new List<Job>{ Job.None }, new List<IEffect>(){ new MpRecovery(50) }, UseableIn.Both, true) },
            { 1007, new ActiveItem("마나 물약", "사용시 마나를 100 회복한다.", 400, new List<Job>{ Job.None }, new List<IEffect>(){ new MpRecovery(100) }, UseableIn.Both, true) },
            { 1008, new ActiveItem("마나 물약", "사용시 마나를 200 회복한다.", 800, new List<Job>{ Job.None }, new List<IEffect>(){ new MpRecovery(200) }, UseableIn.Both, true) },
            { 1009, new ActiveItem("마나 물약", "사용시 마나를 전부 회복한다.", 3000, new List<Job>{ Job.None }, new List<IEffect>(){ new MpRecovery(9999999) }, UseableIn.OnlyCombat, true) },
